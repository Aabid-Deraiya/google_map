...
class Info_2 extends StatelessWidget {
  const Info_2({Key? key}) : super(key: key);
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image:
                    DecorationImage(image: AssetImage("assets/Info_2.png"))),
              ),
              SizedBox(
              ...
              Container(
                width: dimension.width30 * 7,
                child: BigText(text: "Security & secure payment method"),
              ),
              SizedBox(
                height: dimension.height30,
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Button(onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>Info_3()));
